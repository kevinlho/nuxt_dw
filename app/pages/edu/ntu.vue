                ...
                >
                  ...
                  <template v-else-if="section.id === 'keybenefits'">
                    <div class="text-gray-700 space-y-4">
                      <div
                        ...
                        :key="group.title"
                      >
                        <h2 class="text-2xl font-semibold mt-4">{{ group.title }}</h2>
                  ...
                  <template v-else-if="section.id === 'programme'">
                    <div class="text-gray-700 space-y-4">
                      ...
                      <h2 class="text-2xl font-semibold">Course Objective</h2>
                      ...
                      <h2 class="text-2xl font-semibold">Course Outline</h2>
                      <div
                        v-for="s in [
                      ...
                      <h2 class="text-2xl font-semibold">Exciting Tours &amp; Learning Journey</h2>
                  ...
                  <template v-else-if="section.id === 'attend'">
                    <div class="text-gray-700 space-y-3">
                      ...
                      <p class="text-sm italic">* Applicants who do not fully meet the above requirements may still be considered on a case-by-case basis, subject to an interview.</p>
                    </div>
                  </template>
                    ...
                    <div class="border border-gray-200 rounded-2xl overflow-hidden bg-blue-50">
                      <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6">
                        ...
                        <div class="flex flex-col justify-center text-center sm:text-left space-y-2">
                          <h3 class="text-xl font-semibold text-gray-900">Dr. Guoqiang Hu</h3>
